...
class PortfolioItem(db.Model):
    ...
    video_url = db.Column(db.String(255), nullable=True)  # رابط الفيديو الخارجي (يوتيوب، فيميو، إلخ)
    video_file = db.Column(db.String(255), nullable=True)  # مسار ملف الفيديو المحلي
    video_type = db.Column(db.String(20), nullable=True)  # نوع الفيديو (external/local/embed)
    video_thumbnail = db.Column(db.String(255), nullable=True)  # صورة مصغرة للفيديو
    ...
    def has_carousel(self):
        """التحقق مما إذا كان العنصر يحتوي على صور متعددة"""
    ...
    @property
    def has_video(self):
        """التحقق مما إذا كان العنصر يحتوي على فيديو"""

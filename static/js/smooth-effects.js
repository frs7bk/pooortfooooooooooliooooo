...
function initSmoothEffects() {
  ...
  if (typeof AOS !== 'undefined') {
    AOS.init({
      duration: 700, // خفض المدة لتأثير أسرع استجابة
      easing: 'ease-out-cubic',
      once: false,
      mirror: true, // عكس التأثير عند التمرير للخلف
      delay: 50, // تأخير بسيط لجعل التأثيرات أكثر طبيعية
      offset: 100, // تحسين مسافة التفعيل
      anchorPlacement: 'top-center', // تفعيل التأثير قبل وصول العنصر للمنتصف
      disable: false // تفعيل على جميع الأجهزة
    });
    
    // إضافة معالج لتحديث AOS عند التمرير لمعالجة مشكلة الأقسام التي تظهر بعد تخطيها
